...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :node101 do |node101|
    node101.vm.hostname = "node1.net10"
    node101.vm.network "private_network", ip: "192.168.10.101", virtualbox__intnet: "net10"
  end

  config.vm.define :node201 do |node201|
    node201.vm.hostname = "node1.net20"
    node201.vm.network "private_network", ip: "192.168.20.201", virtualbox__intnet: "net20"
  end

  config.vm.define :node301 do |node301|
    node301.vm.hostname = "node1.net30"
    node301.vm.network "private_network", ip: "192.168.30.201", virtualbox__intnet: "net30"
  end
